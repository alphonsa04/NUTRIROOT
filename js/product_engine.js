...
const ProductEngine = {
    ...
    async fetchProducts() {
        ...
        try {
            ...
            // Auto-seed if empty or missing new products (e.g., < 15 items)
            ...
            const fallbackProducts = [
                // Nitrogen
                { id: "urea_46", name: "Urea (46-0-0)", category: "Nitrogen Fertilizers", nitrogen_percent: 46, phosphorus_percent: 0, potassium_percent: 0, price: 266.50, stock_quantity: 500, description: "High-concentration nitrogen fertilizer.", image_url: "assets/images/products/urea.png" },
                { id: "ammonium_sulphate", name: "Ammonium Sulphate (21-0-0)", category: "Nitrogen Fertilizers", nitrogen_percent: 21, phosphorus_percent: 0, potassium_percent: 0, price: 850.00, stock_quantity: 200, description: "Provides Nitrogen and Sulfur. High quality.", image_url: "assets/images/products/amsul.png" },

                // Phosphatic
                { id: "dap_18_46", name: "DAP (18-46-0)", category: "Phosphatic Fertilizers", nitrogen_percent: 18, phosphorus_percent: 46, potassium_percent: 0, price: 1350.00, stock_quantity: 300, description: "Excellent for root development.", image_url: "assets/images/products/dap.png" },
                { id: "ssp_16", name: "SSP (0-16-0)", category: "Phosphatic Fertilizers", nitrogen_percent: 0, phosphorus_percent: 16, potassium_percent: 0, price: 450.00, stock_quantity: 400, description: "Cost-effective Phosphorus source.", image_url: "assets/images/products/ssp.png" },

                // Potassic
                { id: "mop_60", name: "MOP (0-0-60)", category: "Potassic Fertilizers", nitrogen_percent: 0, phosphorus_percent: 0, potassium_percent: 60, price: 1700.00, stock_quantity: 250, description: "Improves disease resistance.", image_url: "assets/images/products/mop.png" },

                // Complex NPK
                { id: "npk_20_20_20", name: "NPK 20-20-20", category: "Complex NPK Fertilizers", nitrogen_percent: 20, phosphorus_percent: 20, potassium_percent: 20, price: 220.00, stock_quantity: 150, description: "Balanced fertilizer for general growth.", image_url: "assets/images/products/npk20.png" },
                { id: "npk_10_26_26", name: "NPK 10-26-26", category: "Complex NPK Fertilizers", nitrogen_percent: 10, phosphorus_percent: 26, potassium_percent: 26, price: 1400.00, stock_quantity: 100, description: "High P and K content.", image_url: "assets/images/products/npk102626.png" },
                { id: "npk_12_32_16", name: "NPK 12-32-16", category: "Complex NPK Fertilizers", nitrogen_percent: 12, phosphorus_percent: 32, potassium_percent: 16, price: 1450.00, stock_quantity: 120, description: "Phosphorus-rich complex fertilizer.", image_url: "assets/images/products/npk123216.png" },
                { id: "npk_19_19_19", name: "NPK 19-19-19", category: "Complex NPK Fertilizers", nitrogen_percent: 19, phosphorus_percent: 19, potassium_percent: 19, price: 180.00, stock_quantity: 300, description: "Balanced water-soluble fertilizer.", image_url: "assets/images/products/npk19.png" },

                // Organic
                { id: "vermicompost", name: "Premium Vermicompost", category: "Organic Fertilizers", nitrogen_percent: 1.5, phosphorus_percent: 0.5, potassium_percent: 0.5, price: 250.00, stock_quantity: 1000, description: "Organic manure for soil health.", image_url: "assets/images/products/vermicompost.png" },
                { id: "neem_cake", name: "Neem Cake", category: "Organic Fertilizers", nitrogen_percent: 2, phosphorus_percent: 1, potassium_percent: 1, price: 950.00, stock_quantity: 400, description: "Natural pesticide and soil conditioner.", image_url: "assets/images/products/neem_cake.png" },

                // Conditioners
                { id: "zinc_sulphate", name: "Zinc Sulphate", category: "Soil Conditioners", nitrogen_percent: 0, phosphorus_percent: 0, potassium_percent: 0, price: 180.00, stock_quantity: 150, description: "Used to correct Zinc deficiency.", image_url: "assets/images/products/zinc.png" },
                { id: "gypsum", name: "Gypsum", category: "Soil Conditioners", nitrogen_percent: 0, phosphorus_percent: 0, potassium_percent: 0, price: 250.00, stock_quantity: 300, description: "Used for soil conditioning.", image_url: "assets/images/products/gypsum.png" }
            ];
